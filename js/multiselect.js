...
//Storing the values of checked items - Vivek. See line 198
checkedValues = [];
...
$.widget("ech.multiselect", {
	...
	options: {
		...
		noneSelectedText: 'Neighbourhoods',
	...
	update: function(){
		...
		$.each($($checked), function(i, val) {
			//In case we need to store ID too, then uncomment below line - Vivek
			//var checkedID = $(val).attr("id").substr(30, $(val).attr("id").length);
			checkedValues.push($(val).attr("title"));
		})
